...
**Champs disciplinaires :** sciences de l'information et de la communication (info-comm), Etudes sur les Sciences, Technologies & Société (STS)

**Méthodes :** Théorisation ancrée, expérimentations méthodes de recherche numériques (*Digital Methods*), utilisation logiciel analyse de données quali (Nvivo, Dedoose), premier pas Python et R pour analyse textuelle et analyse de réseaux 
...
- **Blog de ce site :** à mes heures perdues (donc pas énormément de [billets de blog](http://celyagd.github.io/blog/))
