...
Avec HackYourPhD, j'ai débuté une première exploration de la thématique Open Science / Science ouverte [au Québec](http://hackyourphd-quebec.strikingly.com/). Durant l'été 2013, j'ai réalisé un grant tour des USA pour rencontrer des acteurs clefs de l'*Open Science* et mieux comprendre les racines de ce mouvement. Ce projet []HackYourPhD aux States](http://hackyourphd-aux-states.strikingly.com/) a été financé par une campagne de financement participatif. Toutes les ressources, interviews, carnet de voyage sont en ligne sur le site. Un livre a aussi été réalisé par la suite  
...
- [Open Geek Workshops](http://hackyourphd.org/ateliers-open-geek/)
- Atelier Open Science à la Cité des Sciences
- et plus ==> [HackYourPhD website](http://hackyourphd.org/evenements/)
...
*You will find most recent presentation on the research part of this website (related to my PhD Studies). Presentations below are mainly in french.*
